...
import (
	...
	"github.com/aditya43/golang_github_microservice/src/api/clients/restclient"
...
func TestCreateRepoNoError(t *testing.T) {
	...
	restclient.AddMockup(restclient.Mock{
		...
		Response: &http.Response{
			StatusCode: http.StatusCreated,
			Body:       ioutil.NopCloser(strings.NewReader(`{"id": 123,"name": "golang-tutorial","full_name": "adityahajare/golang-tutorial"}`)),
		},
	})
	...
	assert.EqualValues(t, "adityahajare/golang-tutorial", response.FullName)
}
